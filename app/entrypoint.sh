...
# Copy frontend files
cp /speedtest/*.js /usr/share/nginx/html/
cp -r /speedtest/assets /usr/share/nginx/html/assets

# Copy favicon
cp /speedtest/favicon.ico /usr/share/nginx/html/

cp -r /speedtest/backend/ /usr/share/nginx/html/backend

cp /speedtest/ui.php /usr/share/nginx/html/index.php
...
# Add PHP-FPM location block to nginx config (before the last closing brace)
PHP_CONFIG='        location ~ \.php$ {\n            fastcgi_pass 127.0.0.1:9000;\n            fastcgi_index index.php;\n            include fastcgi.conf;\n        }'
sed -i "/^\}/i\\${PHP_CONFIG}" "${CONFIG}"
